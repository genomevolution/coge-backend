...
class AnnotationAlchemy(Base):
    ...
    genome = relationship("GenomeAlchemy", back_populates="annotations")
    annotation_files = relationship("AnnotationFileAlchemy", back_populates="annotation", lazy='noload')
